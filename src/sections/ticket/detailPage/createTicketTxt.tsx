...
const CreateTicketTxt: React.FC = () => {
  ...
  return (
    <>
      <Button variant="outlined" startIcon={<PlusOutlined />} onClick={() => setOpen(true)}>
      {t("ticket.drawer.create_dialog.title")}
      </Button>
...
export default CreateTicketTxt;
